...
export TPHT_HEAVY_WORKERS="${TPHT_HEAVY_WORKERS:-8}"
export GMD2026_ANALYSIS_JOB_NAME="02_tpht_heavy_parallel"
export GMD2026_ANALYSIS_COMMAND='bash analysis/02_tpht/run_02_tpht_heavy_parallel.sh --root "${GMD2026_ROOT}" --outdir "${GMD2026_OUTDIR}" ${GMD2026_ANALYSIS_ARGS:-}'
