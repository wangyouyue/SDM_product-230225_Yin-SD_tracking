...
export GMD2026_ANALYSIS_JOB_NAME="05_outint_io"
export GMD2026_ANALYSIS_COMMAND='${GMD2026_PYTHON} analysis/05_outint_io/analyze_05_outint_io.py --root "${GMD2026_ROOT}" --outdir "${GMD2026_OUTDIR}" ${GMD2026_ANALYSIS_ARGS:-}'
