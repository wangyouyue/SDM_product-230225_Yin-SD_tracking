...
export GMD2026_ANALYSIS_JOB_NAME="01_benchmark"
export GMD2026_ANALYSIS_COMMAND='${GMD2026_PYTHON} analysis/01_benchmark/analyze_01_benchmark.py --root "${GMD2026_ROOT}" --outdir "${GMD2026_OUTDIR}" ${GMD2026_ANALYSIS_ARGS:-}'
