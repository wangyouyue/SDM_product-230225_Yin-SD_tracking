...
export GMD2026_ANALYSIS_JOB_NAME="00_restart"
export GMD2026_ANALYSIS_COMMAND='${GMD2026_PYTHON} analysis/00_restart/analyze_00_restart.py --root "${GMD2026_ROOT}" --outdir "${GMD2026_OUTDIR}" ${GMD2026_ANALYSIS_ARGS:-}'
