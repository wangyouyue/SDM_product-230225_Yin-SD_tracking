...
export GMD2026_ANALYSIS_JOB_NAME="all_analysis"
export GMD2026_ANALYSIS_COMMAND='bash analysis/run_all_analysis.sh --root "${GMD2026_ROOT}" --outdir "${GMD2026_OUTDIR}" ${GMD2026_ANALYSIS_ARGS:-}'
