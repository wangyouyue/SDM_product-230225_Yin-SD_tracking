...
export GMD2026_ANALYSIS_JOB_NAME="02_tpht_light"
export GMD2026_ANALYSIS_COMMAND='bash analysis/02_tpht/run_02_tpht_light.sh --root "${GMD2026_ROOT}" --outdir "${GMD2026_OUTDIR}" ${GMD2026_ANALYSIS_ARGS:-}'
