...
export GMD2026_ANALYSIS_JOB_NAME="04_sdnc_scaling"
export GMD2026_ANALYSIS_COMMAND='${GMD2026_PYTHON} analysis/04_sdnc_scaling/analyze_04_sdnc_scaling.py --root "${GMD2026_ROOT}" --outdir "${GMD2026_OUTDIR}" ${GMD2026_ANALYSIS_ARGS:-}'
