PROGRAM ParticleTracer
  ...
  CHARACTER(LEN=64)  :: sd_all_prefix = "SD_selected_NetCDF_"
  ...
  CHARACTER(LEN=10)  :: time_start_str = "010000.000" ! Tracking start time (earliest time)
  CHARACTER(LEN=10)  :: time_end_str   = "013000.000" ! MODIFIED: Tracking end time for testing
  INTEGER            :: time_interval_milliseconds = 5000 
  REAL(KIND=8)       :: filter_radius_gt = 1.0E-15_8 ! sd_r filter threshold (m)
  REAL(KIND=8)       :: filter_height_gt = 0.0_8     ! sd_z filter threshold (m)

  INTEGER            :: PRC_NUM_X = 40 ! Example value, number of domains in X direction
