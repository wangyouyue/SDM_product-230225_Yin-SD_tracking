        ...
        if cache is not None:
            if filename not in cache:
                ...
                cache[filename] = {
                    ...
                    'pre_sdid': read_tracking_var(nc, ['sd_id', 'pre_sdid'], ['sd_id_', 'pre_sdid_']),
                    'pre_dmid': read_tracking_var(nc, ['dm_id', 'pre_dmid'], ['dm_id_', 'pre_dmid_']),
    ...
    for i, (fname, idx, domain_id) in enumerate(particle_infos):
        try:
            with Dataset(fname, 'r') as nc:
                ...
                pre_sdid_arr = read_tracking_var(nc, ['sd_id', 'pre_sdid'], ['sd_id_', 'pre_sdid_'])
                pre_dmid_arr = read_tracking_var(nc, ['dm_id', 'pre_dmid'], ['dm_id_', 'pre_dmid_'])
                        ...
                        if other_file not in netcdf_cache:
                            try:
                                ...
                                netcdf_cache[other_file] = {
                                    ...
                                    'pre_sdid': read_tracking_var(ofnc, ['sd_id', 'pre_sdid'], ['sd_id_', 'pre_sdid_']),
                                    'pre_dmid': read_tracking_var(ofnc, ['dm_id', 'pre_dmid'], ['dm_id_', 'pre_dmid_']),
...
if __name__ == "__main__":
    input_directory = "../"
    output_dir = "./temp/"
    output_file = "./SD_010000.000_to_011000.000.nc"
